...
var errorRegistry = map[string]ErrorDetail{
	...
	"EVE-103-2":   {Exit: ExitTemplateParse, Message: "non-ASCII whitespace adjacent to placeholder PATH", Detail: "Non‑ASCII whitespace was detected adjacent to the placeholder PATH. Use ASCII SPACE or TAB only when trimming around the placeholder PATH. For example: NG uses U+00A0 immediately after \"pass://\" in \"<pass:// api_key|...>\". OK: \"<pass://api_key|...>\".", DocSlug: "docs/errors.md#eve-103-2"},
	...
	"EVE-103-4":   {Exit: ExitTemplateParse, Message: "invalid placeholder URL near '<pass'", Detail: "URL scheme violation: placeholders MUST start with the literal sequence \"<pass://\" with no whitespace. Do not insert whitespace between \"pass\" and \"://\", and do not use the legacy \"<pass:PATH>\" syntax. For example: NG: \"<pass ://path>\", \"<pass:path|...>\". OK: \"<pass://path|...>\".", DocSlug: "docs/errors.md#eve-103-4"},
	...
	"EVE-103-201": {Exit: ExitTemplateParse, Message: "empty placeholder path", Detail: "The placeholder PATH is empty. Provide a non‑empty PATH in \"<pass://PATH>\". For example: NG: \"<pass://>\". OK: \"<pass://secret/path>\".", DocSlug: "docs/errors.md#eve-103-201"},
	...
	"EVE-103-206": {Exit: ExitTemplateParse, Message: "placeholder PATH is not a valid IRI path", Detail: "The placeholder PATH is not a valid IRI authority + path for the \"pass\" scheme. Ensure that \"pass://PATH\" forms a syntactically valid IRI without query or fragment components, and percent-encode reserved characters such as \"?\", \"#\", \"|\", and \">\" when they need to be embedded in PATH.", DocSlug: "docs/errors.md#eve-103-206"},
	...
	"EVE-104-101": {Exit: ExitResolverFailure, Message: "pass %q failed", Detail: "The `pass` command returned an error for the requested entry. Run `pass <PATH>` to see the underlying cause and resolve the issue such as a missing entry or a permission error.", DocSlug: "docs/errors.md#eve-104-101"},
	...
	"EVE-107-301": {Exit: ExitTargetParse, Message: "placeholders are not allowed in target .env", Detail: "Placeholders are not allowed in the target `.env`. Remove constructs such as \"<pass://...>\" or legacy \"<pass:...>\" placeholders.", DocSlug: "docs/errors.md#eve-107-301"},
