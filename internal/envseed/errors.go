...
var errorRegistry = map[string]ErrorDetail{
	...
	"EVE-101-201": {Exit: ExitInvalidInput, Message: "input file argument is required", Detail: "No `INPUT_FILE` argument was provided. Provide the template path as the `INPUT_FILE` argument. See `envseed <command> --help` for usage.", DocSlug: "docs/errors.md#eve-101-201"},
	"EVE-101-202": {Exit: ExitInvalidInput, Message: "input file %q not found", Detail: "The specified input file was not found. Verify the template path, ensure the file exists, and confirm it is readable.", DocSlug: "docs/errors.md#eve-101-202"},
	"EVE-101-203": {Exit: ExitInvalidInput, Message: "input file %q must contain `envseed` when `--output` is omitted", Detail: "Omitting `--output` requires the template filename to contain `envseed`. Include `envseed` in the template filename or supply `--output`. See `envseed <command> --help` for usage.", DocSlug: "docs/errors.md#eve-101-203"},
	...
	"EVE-101-302": {Exit: ExitInvalidInput, Message: "input path %q is a directory", Detail: "The input path points to a directory. Provide a path to a readable regular file as `INPUT_FILE`.", DocSlug: "docs/errors.md#eve-101-302"},

	// 102 Template Read (I/O)
	"EVE-102-1":   {Exit: ExitTemplateRead, Message: "failed to read template file %q", Detail: "A filesystem or permission error prevented reading the template file. Check the path, confirm the file exists, and ensure it is readable.", DocSlug: "docs/errors.md#eve-102-1"},
	...
	"EVE-103-1":   {Exit: ExitTemplateParse, Message: "non-ASCII whitespace around placeholder separators or before `>`", Detail: "Non‑ASCII whitespace was detected around `|`, `,`, or before `>`. Use ASCII SPACE or TAB only. For example: NG: `<pass:foo | base64>`. OK: `<pass:foo|base64>`.", DocSlug: "docs/errors.md#eve-103-1"},
	"EVE-103-2":   {Exit: ExitTemplateParse, Message: "non-ASCII whitespace adjacent to placeholder PATH", Detail: "Non‑ASCII whitespace was detected adjacent to the placeholder path. Use ASCII SPACE or TAB only when trimming around the placeholder path. For example: NG uses U+00A0 between `:` and `foo`: `<pass:foo|...>`. OK: `<pass:foo|...>`.", DocSlug: "docs/errors.md#eve-103-2"},
	...
	"EVE-103-202": {Exit: ExitTemplateParse, Message: "unterminated placeholder", Detail: "The placeholder is unterminated. Close placeholders with `>` and ensure all modifiers are complete. For example: NG: `<pass:foo|allow_newline`. OK: `<pass:foo|allow_newline>`.", DocSlug: "docs/errors.md#eve-103-202"},
	...
	"EVE-103-301": {Exit: ExitTemplateParse, Message: "missing placeholder modifiers", Detail: "No placeholder modifiers were provided. List at least one modifier after `|`. For example: `<pass:foo|allow_newline>`.", DocSlug: "docs/errors.md#eve-103-301"},
	...
	"EVE-103-303": {Exit: ExitTemplateParse, Message: "duplicate placeholder modifier %q", Detail: "A placeholder modifier was repeated. Specify each modifier at most once. For example: NG: `<pass:foo|strip,strip>`. OK: `<pass:foo|strip>`.", DocSlug: "docs/errors.md#eve-103-303"},
	"EVE-103-304": {Exit: ExitTemplateParse, Message: "empty placeholder modifier", Detail: "An empty placeholder modifier was found. Remove empty entries between commas. For example: NG: `<pass:foo|strip,,base64>`.", DocSlug: "docs/errors.md#eve-103-304"},
	...
	"EVE-107-101": {Exit: ExitTargetParse, Message: "target .env contains non-ASCII whitespace", Detail: "Non‑ASCII whitespace was found in the target `.env`. Use ASCII SPACE or TAB only.", DocSlug: "docs/errors.md#eve-107-101"},
